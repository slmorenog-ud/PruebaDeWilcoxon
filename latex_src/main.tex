...
Según \textcite{wackerly2008}, el procedimiento para aplicar la Prueba de Rangos con Signo de Wilcoxon es el siguiente:
...
Para muestras pequeñas (generalmente $n \leq 25$), la distribución del estadístico $T$ bajo $H_0$ está tabulada. \textcite{wackerly2008} proporcionan tablas con valores críticos para diferentes niveles de significancia $\alpha$.
...
Para tamaños de muestra grandes ($n > 25$), la distribución del estadístico $T^+$ puede aproximarse mediante una distribución normal. Según \textcite{wackerly2008}, bajo la hipótesis nula, los parámetros de esta distribución son:
