...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\footnotesize\itshape Universidad Distrital Francisco José de Caldas - Ingeniería de Sistemas}
\fancyhead[R]{\footnotesize\itshape Probabilidad y Estadística}
\fancyfoot[C]{\thepage}
...
% --- BIBLIOGRAFÍA APA ---
\usepackage[natbibapa]{apacite}  % Paquete para estilo APA
...
\begin{titlepage}
    \begin{center}
        ...
        \linespread{1.0}\huge \textbf{\textit{
            Rompiendo Supuestos: La Potencia Estadística del Método de Wilcoxon
        }}
        \linespread{1}\\[2.5cm]
...
Cuando dos o más diferencias tienen el mismo valor absoluto, se presenta un empate. Como señalan \cite{conover1999} y   \cite{siegel1988}, el procedimiento estándar consiste en asignar a cada valor empatado el promedio de los rangos que les corresponderían. Por ejemplo, si tres valores ocupan las posiciones 4, 5 y 6, cada uno recibe el rango $(4+5+6)/3 = 5$.
...
% --- BIBLIOGRAFÍA ---
\newpage
\bibliography{references}  % Se carga desde references.bib
